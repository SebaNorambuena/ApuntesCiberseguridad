...
La web te permite elegir el color de algunas letras mediante un input 

```HTML
blue}</style><script>alert(1)</script>
```

podemos escapar del estilo y generar código ya sea _**JavaScript**_ o _**HTML**_ pudiendo derivarlo a un _**XSS**_
